...
export default {
  ...
  data () {
    return {
      promoText: {
        ru:
          'Функция "Калькулятор лунных дней" доступна только в Персональном Лунном Календаре',
        en:
          '"Lunar days calculator" option is available only in the Personal Lunar Calendar'
      }
    }
  },
  computed: {
